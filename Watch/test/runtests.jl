...
# !!! Main.UserApp is configured as an alias for Main.Watch and you might encounter it in some tests
using Main.Watch, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Watch tests" begin
  @includetests ARGS
end
